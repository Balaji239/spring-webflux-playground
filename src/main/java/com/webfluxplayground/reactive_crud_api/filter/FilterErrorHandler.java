...
/*
 * Currently spring webflux framework does not have the centralized exception handling solution for filters
 * This is a workaround to handle the exception in filters and send the ProblemDetail as response.
*/
@Service
